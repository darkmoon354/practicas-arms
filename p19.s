// ===============================================
// Estudiante y No de control: Villegas Suarez Francsico Javier 22210364// Descripción: Programa en ensamblador ARM64 para Calcular la longitud de una cadena
// ===============================================
...
class Program
{
    ...
    static int CalcularLongitud(string cadena)
    {
        ...
        // Recorrer cada carácter en la cadena hasta llegar al final
